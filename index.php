...
<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3" style="background:white; margin-bottom:50px;">
  ...
  <div class="login-box-body">
	<h2 align=center style="color:Tomato;" style="margin-bottom:20px"> <i class="fa fa-shield"></i> &nbsp APLIKASI STEGANOGRAFI </h2>
	<div class="nav-tabs-custom">
		<center>
	<img class="img" src="https://raw.githubusercontent.com/rizkyyz/rizkyyz.github.io/main/madoss.png" width="225"/>
	<img class="img" src="https://rizkyyz.github.io/giphy.gif" width="225"/>
	<p>Steganografi adalah seni dan ilmu menulis pesan tersembunyi atau menyembunyikan pesan dengan suatu cara sehingga selain si pengirim dan si penerima, tidak ada seorang pun yang mengetahui atau menyadari bahwa ada suatu pesan rahasia. Sebaliknya, kriptografi menyamarkan arti dari suatu pesan, tapi tidak menyembunyikan bahwa ada suatu pesan.</p>
</center>
...
?>
        <ul class="nav nav-tabs pull-right">
            ...
            <div class="tab-content">
              <div class="tab-pane" id="tab_1">
				<h2 align=center style="color:DodgerBlue;">Deskripsi</h2>
              ...
              <div class="tab-pane active" id="tab_2">  
				<h2 align=center style="color:DodgerBlue;">Enskripsi</h2>
				...
				<img class="img" src="" width="100%" align=center />
              </div>
              <!-- /.tab-pane -->
            </div>
            <!-- /.tab-content -->
		...
		<CENTER>
		<strong>Copyright © 2022 MADOSS TEAM.</strong>
		</CENTER>
	</div>
